...
function question5() {
  ...
  // 5.2. [[], 24, 'hello', true]
  console.log("5.2. Number of elements (4)", ["object(array)", "number", "string", "boolean"]);

  // 5.3. []
  console.log("5.3. Number of elements (0)", []);

  // 5.4. [['romeo', 'juliet'], false]
  console.log("5.4. Number of elements (2)", ["object(array)", "boolean"]);
...
function question6() {
  ...
  console.log("6.4.", "object(array)", "{name: 'Morty', age: 3}, {name: 'Summer', age: 7}");
}
